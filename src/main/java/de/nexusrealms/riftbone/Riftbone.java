...
public class Riftbone implements ModInitializer {
	...
	public static final EntityType<GraveEntity> GRAVE = EntityType.Builder.<GraveEntity>of(GraveEntity::new, MobCategory.MISC).sized(0.375f, 0.375f).build(ResourceKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(MOD_ID, "grave")));
  ...
  public static final GameRule<Boolean> ENABLE_GRAVE_DESPAWN_SOUND = Registry.register(BuiltInRegistries.GAME_RULE, Identifier.fromNamespaceAndPath(MOD_ID, "enable_grave_despawn_sound"), new GameRule<>(GameRuleCategory.PLAYER, GameRuleType.BOOL, BoolArgumentType.bool(), GameRuleTypeVisitor::visitBoolean, Codec.BOOL, (value) -> value ? 1 : 0, true, FeatureFlagSet.of()));
