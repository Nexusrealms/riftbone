...
public class Riftbone implements ModInitializer {
    ...
    public static final GameRule<Boolean> ENABLE_GRAVE_DESPAWN_SOUND = Registry.register(Registries.GAME_RULE, Identifier.of(MOD_ID, "enable_grave_despawn_sound"), new GameRule<>(GameRuleCategory.PLAYER, GameRuleType.BOOL, BoolArgumentType.bool(), GameRuleVisitor::visitBoolean, Codec.BOOL, (value) -> value ? 1 : 0, true, FeatureSet.empty()));
	...
	public static final GameRule<Boolean> OWNER_ONLY_QUICK_LOOTING = Registry.register(Registries.GAME_RULE, Identifier.of(MOD_ID, "owner_only_quick_looting"), new GameRule<>(GameRuleCategory.PLAYER, GameRuleType.BOOL, BoolArgumentType.bool(), GameRuleVisitor::visitBoolean, Codec.BOOL, (value) -> value ? 1 : 0, true, FeatureSet.empty()));
